...
//      }
   ...
   */
  function addPngFromBuf($file, $x, $y, $w =  0, $h =  0, $data = null, $is_mask = false, $mask = null) {
    if ( isset($this->imagelist[$file]) ) {
      //debugpng
   ...
   * @access private
   */
  function addJpegImage_common(&$data, $x, $y, $w =  0, $h =  0, $imageWidth = null, $imageHeight = null, $channels =  3, $imgname = null) {
