...
class Style {
   ...
   */
   ...
   function get_font_family() {
      $DEBUGCSS = DEBUGCSS; // Allow override of global setting for ad hoc debug

      // Resolve font-weight
      $weight = $this->__get("font_weight");
      if (is_numeric($weight)) {
          $weight = ($weight < 600) ? "normal" : "bold";
      ...
      if ($weight === "bold" && ($font_style === "italic" || $font_style === "oblique")) {
          ...
          $subtype = "bold";
      } else if ($font_style === "italic" || $font_style === "oblique") {
          $subtype = "italic";
      } else {
          $subtype = "normal";
      }
