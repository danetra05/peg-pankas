  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-green">
        ...
        <button type="button" class="btn btn-danger" id="cetakaset" >Cetak Laporan</button>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <td>
                    ...
                    <a href="#" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModalhapus<?= $data['id'] ?>"><i class="fa fa-trash"></i>Hapus</a>
