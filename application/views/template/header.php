  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="index2.html" class="logo">
        ...
        <span class="logo-mini"><b>PEG</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>PEG - PANKAS</b></span>
        </a>
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="<?= base_url('') ?>"><i class="fa fa-home"></i>Dashboard</a></li>
                <!--  <li><a href="index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li> -->
              </ul>
            </li>
            <li><a href="<?= base_url('app/data_aset') ?>"><i class="fa fa-database"></i> <span>Data Aset</span></a></li>
            ...
            <li><a href="<?= base_url('app/data_kualitas') ?>"><i class="fa fa-tree"></i> <span>Data Kualitas</span></a></li>
